...
public class PersonageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnFollowandcancel;
    private boolean Followandcancel=false;
    ...
    private void initView() {
        ...
        btnFollowandcancel = findViewById(R.id.btn_followandcancel);
        btnFollowandcancel.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ll_return_binding:
                finish();
                break;
            case R.id.btn_followandcancel:
                if (Followandcancel){
                    btnFollowandcancel.setText("取关");
                    Followandcancel=false;
                }else {
                    btnFollowandcancel.setText("关注");
                    Followandcancel=true;
                }
                break;
    ...
    private void initAdapter(List<MyMultipleItem> basedast) {
        //创建适配器
        adapter = new MultipleItemAdapter(basedast, "0");
        //给RecyclerView设置适配器
